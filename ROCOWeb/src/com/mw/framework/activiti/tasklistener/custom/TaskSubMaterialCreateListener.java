 ...
 * 
 */
public class TaskSubMaterialCreateListener implements TaskListener {
	...
	public void notify(DelegateTask delegatetask) {
		...
		Date time = new Date();
		// 任务困难等级
		Object difLevel = delegatetask.getVariable("difLevel");
		// 将任务丢进任务池
		redisUtils.startTask(assignee, groupId, taskId, difLevel == null ? ""
				: difLevel.toString(), time);

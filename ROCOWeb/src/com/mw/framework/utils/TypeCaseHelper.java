...
public class TypeCaseHelper {
	public static void main(String[] args) {
		System.out.println(Date.valueOf("2011-07-15"));
		//		CgbXpItem cxi = new CgbXpItem();
		//		String a = "2";
		//		Object object = TypeCaseHelper.convert(a, "java.lang.Double", null);
		//		try {
		//			BeanUtils.forceSetProperty(cxi, "price", object);
	...
	public static Object convert(Object obj, String type, String format) throws TypeCastException {
		...
		if (obj instanceof String) {
			...
			if ("Integer".equals(type) || "java.lang.Integer".equals(type))
				try {
					...
					NumberFormat nf = getNf(locale);
					nf.setMaximumFractionDigits(0);
					Number tempNum = nf.parse(str.trim());
			...
			if ("Date".equals(type) || "java.sql.Date".equals(type) || "java.util.Date".equals(type)) {
				if (format == null || format.length() == 0)
					try {
						return DateTools.strToDate(str.replaceAll("\\.", "-"), DateTools.defaultFormat);
					} catch (Exception e) {
						try {
							Locale locale = new Locale("zh", "CN", "");
							DateFormat df = null;
				...
				try {
					...
					SimpleDateFormat sdf = new SimpleDateFormat(DateTools.defaultFormat);
		...
		if (obj instanceof Date) {
			...
			if ("Timestamp".equals(type) || "java.sql.Timestamp".equals(type))
				...
				throw new TypeCastException("Conversion from " + fromType + " to " + type + "--obj-" + obj
	...
	public static String convert2String2(Object obj) throws TypeCastException {
		return (String) convert(obj, "String", DateTools.fullFormat);
	}

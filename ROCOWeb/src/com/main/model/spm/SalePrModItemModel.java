 ...
 * 
 */
public class SalePrModItemModel{
	private String id;
	...
	private String oldAbgru;// 旧的拒绝原因
	...
	public SalePrModItemModel() {
		super();
	}
	
	public SalePrModItemModel(String id, String posnr, String mabnr,
			Integer kwmeng, String arktx, String abgru, Double pr00,
			Double pr01, Double pr02, Double pr03, Double pr04, Double pr05,
			Double zr01, Double zr02, Double zr03, Double zr04, Double zr05,Double zr06,
			String old) {
		super();
		this.id = id;
		this.posnr = posnr;
	...
	public SalePrModItemModel(String id, String posnr, String mabnr,
			Integer kwmeng, String arktx, String abgru, String stateAudit,
			Double pr00, Double pr01, Double pr02, Double pr03, Double pr04,
			Double pr05, Double zr01, Double zr02, Double zr03, Double zr04,
			Double zr05, Double zr06,String old) {
		super();
		this.id = id;
		this.posnr = posnr;
		this.mabnr = mabnr;
	...
	public String getOldAbgru() {
		return oldAbgru;
	}

	public void setOldAbgru(String oldAbgru) {
		this.oldAbgru = oldAbgru;
	}
	...
	public String toString() {
		return "SalePrModItemModel [id=" + id + ", posnr=" + posnr + ", mabnr="
				+ mabnr + ", kwmeng=" + kwmeng + ", arktx=" + arktx
				+ ", abgru=" + abgru + ", stateAudit=" + stateAudit + ", pr00="
				+ pr00 + ", pr01=" + pr01 + ", pr02=" + pr02 + ", pr03=" + pr03

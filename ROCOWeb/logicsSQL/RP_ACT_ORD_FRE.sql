  ...
  CREATE OR REPLACE FORCE VIEW "ROCO_BAK"."ORD_RP_VIEW_FREE" ("ID", "ORDER_DATE", "ORDER_CODE", "JIAO_QI_TIAN_SHU", "PROC_INST_ID_", "ACT_ID", "START_TIME", "END_TIME", "START_ASSIGNEE", "END_ASSIGNEE") AS 
...
select A.ID,A.ORDER_DATE,
 ...
 where a.id = b.id
   ...
   and C.PROC_DEF_ID_ like 'myProcess%' 
 GROUP BY A.ID,
          A.ORDER_DATE,
          A.ORDER_CODE,
          A.JIAO_QI_TIAN_SHU,

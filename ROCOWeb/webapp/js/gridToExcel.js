		...
		.override(
				Ext.grid.GridPanel,
				{
					getExcelXml : function(includeHidden) {
						...
						var totalWidth = 0;
						// calculate totalWidth from each column
						Ext.Array.each(this.columns, function(name, index,
								arraySelf) {
							if (name.dataIndex && !name.hidden) {
								totalWidth += name.width;
							}
						});
						//get the title of tab
						var _title = window.parent.Ext.ComponentQuery
								.query('tabpanel')[0].getActiveTab().title;
 ...
 * @returns
 */
var ExportExcelByGrid = function(grid) {
